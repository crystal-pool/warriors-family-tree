...
export declare type HostMessage = IInitializeMessage;
export declare type EmbedMessage = IEmbedReadyMessage | IEmbedDocumentHeightChangedMessage | IEmbedFamilyTreeNodeClickMessage;
